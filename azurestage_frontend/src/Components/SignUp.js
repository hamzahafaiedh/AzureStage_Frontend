              ...
              <div className="card bg-dark text-white" style={{borderRadius: '1rem'}}>
                <div className="card-body p-5 text-center">
                  <div className="mb-md-5 mt-md-4 pb-5">
                    ...
                    <button className="btn btn-outline-light btn-lg px-5 mt-5" type="submit">Sign Up</button>
                  ...
                  <div>
                    <p className="mb-0">Already have an account? <a href="/signin" className="text-white-50 fw-bold">Login</a>
                    </p>
                  </div>
                </div>
              </div>
